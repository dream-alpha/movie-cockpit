...
def parseTemplate(template_string):
	...
	#print("MVC: MovieList: parseTemplate: list_styles: " + str(list_styles))
	#print("MVC: MovieList: parseTemplate: template_attributes: " + str(template_attributes))
	return list_styles, template_attributes


def main():
	print("Checking movie list template...")
