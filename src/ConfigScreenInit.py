...
class ConfigScreenInit(ConfigStylesScreenInit):
	def __init__(self, session):
		...
		self.config_list = [
			...
			(_("Automatic cleanup of timers list")              , config.plugins.moviecockpit.timer_autoclean           , None                  , None                  , 1     , []          , _("Select whether covers should be downloaded automatically for recordings.")),
